...
/**
 * Medical view toggle button with included trailing icon as well as compact and expanded
...
fun MedicalViewToggleButton(
    ...
    TextButton(
        ...
        contentPadding = MedicalViewToggleDefaults.ViewToggleButtonContentPadding,
    ) {
        MedicalViewToggleButtonContent(
            text = if (expanded) expandedText else compactText,
            trailingIcon = {
                Icon(
                    imageVector = if (expanded) MedicalIcons.ViewDay else MedicalIcons.ShortText,
...
/**
 * Internal Medical view toggle button content layout for arranging the text label and
 * trailing icon.
 *
 ...
 */
@Composable
private fun MedicalViewToggleButtonContent(
...
/**
 * Medical view toggle default values.
 */
object MedicalViewToggleDefaults {
    // TODO: File bug
