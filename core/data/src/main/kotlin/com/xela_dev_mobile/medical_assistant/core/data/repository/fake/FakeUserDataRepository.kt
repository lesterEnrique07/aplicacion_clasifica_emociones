...
package com.xela_dev_mobile.medical_assistant.core.data.repository.fake
...
class FakeUserDataRepository @Inject constructor(
    ...
    override suspend fun setFollowedTopicIds(followedTopicIds: Set<String>) =
        medicalPreferencesDataSource.setFollowedTopicIds(followedTopicIds)

    override suspend fun setTopicIdFollowed(followedTopicId: String, followed: Boolean) =
        medicalPreferencesDataSource.setTopicIdFollowed(followedTopicId, followed)

    override suspend fun updateNewsResourceBookmark(newsResourceId: String, bookmarked: Boolean) {
        medicalPreferencesDataSource.setNewsResourceBookmarked(newsResourceId, bookmarked)
    }

    override suspend fun setNewsResourceViewed(newsResourceId: String, viewed: Boolean) =
        medicalPreferencesDataSource.setNewsResourceViewed(newsResourceId, viewed)
